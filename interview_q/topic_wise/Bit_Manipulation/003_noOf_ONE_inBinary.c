...
//then by performing x&(x-1), and storing it in x, 
//will reduce x to a number containing number of ones(in its binary form) less than the previous state of x, 
//therefore increase the value of count in each iteration till x!=0
...
As n-1 = 22 = {10110}2 , 
then n&(n-1) will be {101112 & {10110}2, 
which will be {10110}2 which is equal to 22.
...
3. As n-1 = 21 = {10101}2 ,
then n&(n-1) will be {10110}2 & {10101}2,
which will be {10100}2 which is equal to 20. 
...
which will be {10000}2 which is equal to 16.
...
5. As n-1 = 15 = {01111}2 , 
then n&(n-1) will be {10000}2 & {01111}2, 
which will be {00000}2 which is equal to 0. 
